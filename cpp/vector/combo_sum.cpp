...
static void example(const std::vector<int> &candidates, int target) {
...
static void f1(void) { example({2, 3, 6, 7}, 7); }
static void f2(void) { example({2, 3, 5}, 8); }
static void f3(void) { example({2}, 1); }
static void f4(void) { example({1}, 1); }
static void f5(void) { example({1}, 2); }
static void f6(void) { example({8,7,4,3}, 11); }
static void f7(void) { example({7,3,9,6}, 6); }
static void f8(void) { example({7,5,8,12,3,10,9,4,11,6}, 21); }
static void f9(void) { example({5,4,2,3}, 14); }
static void f10(void) { example({48,22,49,24,26,47,33,40,37,39,31,46,36,43,45,34,28,20,29,25,41,32,23}, 69); }
